var startTime = Date.now(), endTime, elapsedTime;
...
function solve(nQueensSize, nQueenPositions, currentColumn, finalCallback) {
    ...
    if (finalCallback) {
        finalCallback.apply(this, [solutions]);
    } else {
        return solutions;
    }
}
...
solve(nQueensSize, [], 0, function(solutions) {
    endTime = Date.now();
